...
import static com.masteringselenium.driver.DriverType.FIREFOX;
...
public class WebDriverThread {
    ...
    private void instantiateWebDriver(MutableCapabilities capabilities) {
        ...
        if (useRemoteWebDriver) {
            try {
                URL remoteDriverURL = new URL(System.getProperty("remoteDriverURL"));
                ...
                webDriver = new RemoteWebDriver(remoteDriverURL, capabilities);

            } catch (MalformedURLException e) {
                log.error("Remote Driver URL either absent or corrupted", e);
            }
        } else {
